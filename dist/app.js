...
/***/ function(module, exports, __webpack_require__) {
	...
	var users_module_1 = __webpack_require__(75);
	var map_module_1 = __webpack_require__(84);
	var app_routes_1 = __webpack_require__(94);
	var app_component_1 = __webpack_require__(97);
	var nav_component_1 = __webpack_require__(103);
	var login_component_1 = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(3), __webpack_require__(28), __webpack_require__(4), __webpack_require__(5), __webpack_require__(29)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavService = (function () {
	    function NavService() {
	        this.titleChangedSource = new Subject_1.Subject();
	        this.messageChangedSource = new Subject_1.Subject();
	        this.loggedInSource = new Subject_1.Subject();
	        this.titleChanged$ = this.titleChangedSource.asObservable();
	        this.messageChanged$ = this.messageChangedSource.asObservable();
	        this.loggedIn$ = this.loggedInSource.asObservable();
	        this.messageQueue = [];
	    }
	    NavService.prototype.changeTitle = function (title) {
	    ...
	    NavService.prototype.queueMessage = function (message) {
	        this.messageQueue.push(message);
	    };
	    NavService.prototype.getMessages = function () {
	    ...
	    NavService.prototype.logIn = function (user) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthService = (function () {
	    function AuthService(router, http, navService) {
	        var _this = this;
	        this.router = router;
	        this.http = http;
	        ...
	        this.handleLoginResponse = function (response) {
	            ...
	            if (response.ok) {
	                _this._loggedInUser = null;
	                _this.navService.logIn(response.data);
	                _this.navService.queueMessage('Welcome, ' + response.data.username);
	                _this.router.navigateByUrl('/');
	            }
	            else {
	                _this.navService.changeMessage(response.error);
	            }
	        };
	    }
	    ...
	    AuthService.prototype.logout = function () {
	        ...
	        return this.http.get(this.apiBase + 'logout')
	            ...
	            if (response.ok) {
	                _this._loggedInUser = null;
	                _this.navService.changeMessage('Successfully logged out. See you next time!');
	            }
	            else {
	                _this.navService.changeMessage('Error logging out!');
	            }
	            return response;
	        })
	            .catch(this.handleError);
	    };
	    AuthService.prototype.handleObservableError = function (error) {
	    ...
	    AuthService = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [router_1.Router, http_1.Http, index_1.NavService])
	    ], AuthService);
	    return AuthService;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http_1 = __webpack_require__(26);
	__webpack_require__(62);
	var nav_service_1 = __webpack_require__(32);
	var UserService = (function () {
	    function UserService(http, navService) {
	        ...
	        this.handleError = function (error) {
	            _this.navService.changeMessage(error);
	        };
	    }
	    ...
	    UserService.prototype.put = function (form, id) {
	        var _this = this;
	        var headers = new http_1.Headers({
	            'Content-Type': 'application/json'
	        });
	        var url = this.apiBase + id;
	        return this.http.put(url, JSON.stringify(form), { headers: headers })
	            ...
	            _this.navService.changeMessage(msg);
	        })
	            .catch(this.handleError);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var users_component_1 = __webpack_require__(76);
	var user_profile_component_1 = __webpack_require__(78);
	var profile_edit_component_1 = __webpack_require__(80);
	var shared_module_1 = __webpack_require__(25);
	var users_routing_1 = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersComponent = (function () {
	    function UsersComponent(userService, authService, navService, router) {
	    ...
	    UsersComponent.prototype.gotoEditProfile = function (id) {
	    ...
	    UsersComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [index_1.UserService, index_1.AuthService, index_1.NavService, router_1.Router])
	    ], UsersComponent);
...
/***/ function(module, exports) {
	...
	module.exports = "<h1>{{title}}</h1>\n<h2>My Heroes</h2>\n<ul class=\"users mdl-list\">\n  <li *ngFor=\"let user of users\" (click)=\"onSelect(user)\" [class.selected]=\"user === selectedUser\" class=\"mdl-list__item mdl-list__item--two-line\">\n    <span class=\"mdl-list__item-primary-content\">\n      <a [routerLink]=\"['/user', user._id]\">\n        <i class=\"material-icons mdl-list__item-avatar\">person</i>\n      </a>\n      <span>{{user.username}}</span>\n      <span *ngIf=\"user.admin\"> - Admin</span>\n      <span class=\"mdl-list__item-sub-title\">{{user.email}}</span>\n    </span>\n    <span class=\"\">\n      <button class=\"mdl-list__item-secondary-action mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored\" (click)=\"gotoEditProfile(user._id)\">\n        <i class=\"material-icons\">edit</i>\n      </button>\n      <button class=\"mdl-list__item-secondary-action mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored\" (click)=\"deleteUser(user, $event)\">\n        <i class=\"material-icons\">delete</i>\n      </button>\n    </span>\n\n\n  </li>\n</ul>\n<div class=\"error\" *ngIf=\"error\">{{error}}</div>\n\n<div *ngIf = \"selectedUser\">\n  <h2>{{selectedUser.username | uppercase}} is my hero</h2>\n  <button (click)=\"gotoProfile()\">View Profile</button>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserProfileComponent = (function () {
	    function UserProfileComponent(userService, navService, route) {
	        this.userService = userService;
	        this.navService = navService;
	        this.route = route;
	    ...
	    UserProfileComponent.prototype.ngOnInit = function () {
	        ...
	        this.sub = this.route.params.subscribe(function (params) {
	            if (params['id'] !== undefined) {
	                ...
	                _this.userService.get(id)
	                    .then(function (user) {
	                    if (user) {
	                        _this.user = user;
	                        _this.navService.changeTitle(user.username + '\'s Profile');
	                    }
	                })
	    ...
	    UserProfileComponent.prototype.editToggle = function () {
	        if (!this.editing)
	            this.editing = true;
	        else
	            this.editing = false;
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], UserProfileComponent.prototype, "close", void 0);
	    UserProfileComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [index_1.UserService, index_1.NavService, router_1.ActivatedRoute])
...
/***/ function(module, exports) {
	...
	module.exports = "<div *ngIf=\"user\">\n\n  <h2>\n    <span>{{user.username}}</span>\n    <a class=\"mdl-list__item-secondary-action mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored\"\n      [routerLink]=\"['/edit_user', user._id]\"\n    >\n      <i class=\"material-icons\">mode_edit</i>\n    </a>\n  </h2>\n\n  <div>\n    <label>id: </label>{{user._id}}\n  </div>\n  <div>\n    <label>username: </label>{{user.username}}\n  </div>\n  <div>\n    <label>name: </label>{{user.name}}\n  </div>\n  <div>\n    <label>email: </label>{{user.email}}\n  </div>\n\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileEditComponent = (function () {
	    function ProfileEditComponent(userService, navService, route, authService) {
	        this.userService = userService;
	        this.navService = navService;
	        this.route = route;
	        this.authService = authService;
	        ...
	        this.sub = this.route.params.subscribe(function (params) {
	            if (params['id'] !== undefined) {
	                ...
	                _this.userService.get(id)
	                    ...
	                    if (user) {
	                        _this.user = user;
	                        _this.navService.changeTitle('Editing user ' + user.username);
	                    }
	                });
	            }
	            else {
	                _this.adminMode = false;
	                _this.authService.getLoggedInUser()
	                    .subscribe(function (user) {
	                    _this.user = user.data;
	                    _this.navService.changeTitle('Editing your profile');
	                }, function (error) {
	                    _this.error = error;
	                });
	            }
	    ...
	    ProfileEditComponent.prototype.save = function (form) {
	        var _this = this;
	        this.userService
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], ProfileEditComponent.prototype, "user", void 0);
	    ProfileEditComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [index_1.UserService, index_1.NavService, router_1.ActivatedRoute, index_1.AuthService])
...
/***/ function(module, exports) {
	...
	module.exports = "<div *ngIf=\"user\">\n  <div>\n    <label>id: </label>{{user._id}}\n  </div>\n\n  <form (ngSubmit)=\"save(f.value)\" #f=\"ngForm\">\n    <div>\n      <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n        <input [(ngModel)]=\"user.username\" class=\"mdl-textfield__input\" type=\"text\" id=\"username\" name=\"username\">\n        <label for=\"username\">Username</label>\n      </div>\n\n      <div class=\"mdl-textfield mdl-js-textfield\">\n        <input [(ngModel)]=\"user.password\" class=\"mdl-textfield__input\" type=\"password\" id=\"password\" name=\"password\">\n        <label for=\"password\">Password</label>\n      </div>\n    </div>\n\n    <div>\n      <div class=\"mdl-textfield mdl-js-textfield\">\n        <input [(ngModel)]=\"user.name\" class=\"mdl-textfield__input\" type=\"text\" id=\"name\" name=\"name\">\n        <label for=\"name\">Name</label>\n      </div>\n\n      <div class=\"mdl-textfield mdl-js-textfield\">\n        <input [(ngModel)]=\"user.email\" class=\"mdl-textfield__input\" type=\"text\" id=\"email\" name=\"email\">\n        <label for=\"name\">Email</label>\n      </div>\n    </div>\n\n    <button type=\"submit\">Submit</button>\n  </form>\n\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = [
	    ...
	    {
	        path: 'user/:id',
	        component: index_1.UserProfileComponent
	    },
	    {
	        path: 'edit_user/:id',
	        component: index_1.ProfileEditComponent,
	        canActivate: [index_2.AdminGuard]
	    },
	    {
	        path: 'editprofile',
	        component: index_1.ProfileEditComponent,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map2_component_1 = __webpack_require__(89);
	var map_marker_component_1 = __webpack_require__(90);
	var map_infowindow_component_1 = __webpack_require__(92);
	var shared_module_1 = __webpack_require__(25);
	var map_routing_1 = __webpack_require__(93);
	var map_service_1 = __webpack_require__(86);
	    ...
	    MapModule = __decorate([
	        core_1.NgModule({
	            declarations: [
	                ...
	                map2_component_1.Map2Component,
	                map_marker_component_1.MapMarker,
	                map_infowindow_component_1.MapInfowindow
	            ],
	            imports: [
	                shared_module_1.SharedModule,
	                map_routing_1.mapRouting
	            ],
	            providers: [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapComponent = (function () {
	    function MapComponent(ngZone, mapService, route) {
	        this.ngZone = ngZone;
	        this.mapService = mapService;
	        this.route = route;
	        this.noMapMode = false;
	        this.navigated = false;
	    ...
	    MapComponent.prototype.ngOnInit = function () {
	        ...
	        this.sub = this.route.params.subscribe(function (params) {
	            if (params['id'] !== undefined) {
	                var id = params['id'];
	                _this.mapService.getMap(id)
	                    .subscribe(function (map) {
	                    _this.mapObject = map;
	                    if (!_this.noMapMode)
	                        _this.placeMarkersAndInfoWindows();
	                });
	            }
	            else {
	                _this.navigated = false;
	                _this.mapObject = _this.getMockMap();
	                if (!_this.noMapMode)
	                    _this.placeMarkersAndInfoWindows();
	            }
	        });
	    ...
	    MapComponent.prototype.addNewLocation = function (lat, lng) {
	        var _this = this;
	        this.resetInterface();
	        ...
	        this.newMarker.addListener('click', (function () {
	            return function (e) {
	                this.ngZone.run(function () { return document.getElementById("titleInput").focus(); });
	            }.bind(_this);
	        })());
	    };
	    MapComponent.prototype.saveNewLocation = function () {
	    ...
	    MapComponent.prototype.cancelNewLocation = function () {
	        this.resetInterface();
	    };
	    MapComponent.prototype.selectLocation = function (i) {
	        this.resetInterface();
	    ...
	    MapComponent.prototype.editLocation = function (i) {
	        this.selectLocation(i);
	        this.editMode = true;
	    };
	    MapComponent.prototype.saveLocation = function (i) {
	        this.resetInterface();
	        this.selectedLocation = i;
	    ...
	    MapComponent.prototype.removeLocation = function (i) {
	        this.resetInterface();
	        this.closeInfoWindow(i);
	        this.removeMarker(i);
	        this.mapObject.locations.splice(i, 1);
	    };
	    MapComponent.prototype.saveMap = function () {
	        var _this = this;
	    ...
	    MapComponent.prototype.getMockMap = function () {
	        return { locations: [
	    ...
	    MapComponent.prototype.resetInterface = function () {
	        this.editMode = false;
	    ...
	    MapComponent.prototype.placeMarkersAndInfoWindows = function () {
	        this.markers = [];
	        this.infoWindows = [];
	    ...
	    MapComponent.prototype.placeMarker = function (i) {
	        var _this = this;
	        ...
	        marker.addListener('click', (function (index) {
	            return function (e) {
	                var _this = this;
	                this.ngZone.run(function () { return _this.selectLocation(index); });
	            }.bind(_this);
	        })(i));
	        this.markers[i] = marker;
	    };
	    MapComponent.prototype.removeMarker = function (i) {
	        var rmMarker = this.markers.splice(i, 1)[0];
	        rmMarker.setMap(null);
	    };
	    MapComponent.prototype.placeInfoWindow = function (i) {
	        var _this = this;
	        var iW = new google.maps.InfoWindow();
	        iW.opened = false;
	        iW.setContent(this.mapObject.locations[i].title);
	        iW.addListener('closeclick', (function (index) {
	            return function (e) {
	                var _this = this;
	                this.ngZone.run(function () { return _this.infoWindows[i].opened = false; });
	            }.bind(_this);
	        })(i));
	        this.infoWindows[i] = iW;
	    };
	    MapComponent.prototype.openInfoWindow = function (i) {
	    ...
	    MapComponent.prototype.closeInfoWindow = function (i) {
	        var iW = this.infoWindows[i];
	        if (iW.opened) {
	            iW.close();
	            iW.opened = false;
	    ...
	    MapComponent.prototype.addNewMarkerListener = function () {
	        var _this = this;
	        this.mapContainer.addListener('click', (function () {
	            return function (e) {
	                var _this = this;
	                this.ngZone.run(function () {
	                    _this.addNewLocation(e.latLng.lat(), e.latLng.lng());
	                });
	            }.bind(_this);
	        })());
	    };
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], MapComponent.prototype, "mapObject", void 0);
	    MapComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [core_1.NgZone, map_service_1.MapService, router_1.ActivatedRoute])
	    ], MapComponent);
	    return MapComponent;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapService = (function () {
	    ...
	    MapService.prototype.initGoogleMap = function () {
	    };
	    MapService.prototype.getGoogleMap = function () {
	        return this.mapContainer;
	    };
	    MapService.prototype.newMap = function (map) {
	        var headers = new http_1.Headers({
	            'Content-Type': 'application/json'
	        });
	        var url = this.apiBase + 'new';
	    ...
	    MapService.prototype.getMap = function (id) {
	        ...
	        return this.http.get(this.apiBase + id)
	            .map(function (res) { return res.json().map; })
	            .catch(this.handleObservableError);
	    };
	    MapService.prototype.saveMap = function (map) {
	        var headers = new http_1.Headers({
	            'Content-Type': 'application/json'
	        });
	        var url = this.apiBase + map._id;
	        return this.http.put(url, JSON.stringify(map), { headers: headers })
	            .map(function (res) { return res.json(); });
	    };
	    MapService.prototype.deleteMap = function (id) {
	        return this.http.delete(this.apiBase + id)
	            .map(function (res) { return res.json().ok; });
	    };
	    MapService.prototype.handleObservableError = function (error) {
	        var errMsg = (error.message) ? error.message :
	            error.status ? error.status + " - " + error.statusText : 'Server error';
	        console.error(errMsg);
	        return Observable_1.Observable.throw(errMsg);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map_marker_component_1 = __webpack_require__(90);
	var map_service_1 = __webpack_require__(86);
	var Map2Component = (function () {
	    function Map2Component(ngZone, changeDetectorRef, mapService, route) {
	        this.ngZone = ngZone;
	    ...
	    Map2Component.prototype.ngOnInit = function () {
	        var _this = this;
	        var mapProp = {
	            zoom: 4,
	            center: { lat: -25.363, lng: 131.044 }
	    ...
	    Map2Component.prototype.ngAfterViewInit = function () {
	    };
	    Map2Component.prototype.ngOnDestroy = function () {
	        this.sub.unsubscribe();
	    };
	    Map2Component.prototype.addNewLocation = function (lat, lng) {
	        this.resetInterface();
	        var latLng = { lat: lat, lng: lng };
	        this.mapContainer.panTo(latLng);
	        this.newLocation = latLng;
	    };
	    Map2Component.prototype.saveNewLocation = function () {
	        var i = this.mapObject.locations.length;
	        this.mapObject.locations.push(this.newLocation);
	        this.resetInterface();
	        this.markerList.toArray()[i].openIW();
	    };
	    Map2Component.prototype.cancelNewLocation = function () {
	        this.resetInterface();
	    };
	    Map2Component.prototype.selectLocation = function (i) {
	        this.resetInterface();
	        var l = this.mapObject.locations[i];
	        this.selectedLocation = i;
	    ...
	    Map2Component.prototype.editLocation = function (i) {
	        this.selectLocation(i);
	        this.editMode = true;
	    };
	    Map2Component.prototype.saveLocation = function (i) {
	        this.resetInterface();
	        this.selectedLocation = i;
	    ...
	    Map2Component.prototype.cancelEdit = function () {
	        this.resetInterface();
	    };
	    Map2Component.prototype.removeLocation = function (i) {
	        this.resetInterface();
	        this.markerList.toArray()[i].closeIW();
	        this.mapObject.locations.splice(i, 1);
	    };
	    Map2Component.prototype.saveMap = function () {
	        var _this = this;
	        console.log(this.mapObject);
	        this.mapService.saveMap(this.mapObject)
	            .subscribe(function (res) {
	    ...
	    Map2Component.prototype.newMarkerClicked = function () {
	        var nL = this.newLocation;
	        this.mapContainer.panTo({ lat: nL.lat, lng: nL.lng });
	        document.getElementById("titleInput").focus();
	    };
	    Map2Component.prototype.markerClicked = function (i) {
	        this.selectLocation(i);
	    };
	    Map2Component.prototype.getMockMap = function () {
	        return { locations: [
	                { title: 'Great Barrier Reef', lat: -18.286111, lng: 147.7, description: 'The Great Barrier Reef is the world\'s largest coral reef system[1][2] composed of over 2,900 individual reefs[3] and 900 islands stretching for over 2,300 kilometres (1,400 mi) over an area of approximately 344,400 square kilometres (133,000 sq mi).[4][5] The reef is located in the Coral Sea, off the coast of Queensland, Australia.' },
	                { title: 'Uluru (Ayers Rock)', lat: -25.363, lng: 131.044, description: 'Uluru /ˌuːləˈruː/ (Pitjantjatjara: Uluṟu), also known as Ayers Rock /ˌɛərz ˈrɒk/ and officially gazetted as "Uluru / Ayers Rock",[1] is a large sandstone rock formation in the southern part of the Northern Territory in central Australia. It lies 335 km (208 mi) south west of the nearest large town, Alice Springs, 450 km (280 mi) by road.' },
	                { title: 'Sydney Opera House', lat: -33.8568, lng: 151.2153, description: 'The Sydney Opera House is a multi-venue performing arts centre in Sydney, Australia, identified as one of the 20th century\'s most distinctive buildings.' }
	    ...
	    Map2Component.prototype.resetInterface = function () {
	        this.editMode = false;
	        this.selectedLocation = null;
	        this.newLocation = null;
	    };
	    Map2Component.prototype.addNewMarkerListener = function () {
	        var _this = this;
	        this.mapContainer.addListener('click', (function () {
	            return function (e) {
	                var _this = this;
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], Map2Component.prototype, "mapObject", void 0);
	    __decorate([
	        core_1.ViewChildren(map_marker_component_1.MapMarker), 
	        __metadata('design:type', core_1.QueryList)
	    ], Map2Component.prototype, "markerList", void 0);
	    Map2Component = __decorate([
	        core_1.Component({
	            selector: 'app-maps',
	            template: __webpack_require__(91),
	            styles: [__webpack_require__(88)]
	        }), 
	        __metadata('design:paramtypes', [core_1.NgZone, core_1.ChangeDetectorRef, map_service_1.MapService, router_1.ActivatedRoute])
	    ], Map2Component);
	    return Map2Component;
	}());
	exports.Map2Component = Map2Component;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapMarker = (function () {
	    function MapMarker(ngZone) {
	        this.ngZone = ngZone;
	        this.onClick = new core_1.EventEmitter();
	    }
	    Object.defineProperty(MapMarker.prototype, "mapContainer", {
	        set: function (mC) {
	    ...
	    ;
	    Object.defineProperty(MapMarker.prototype, "location", {
	        set: function (l) {
	            this._location = l;
	    ...
	    Object.defineProperty(MapMarker.prototype, "index", {
	        set: function (i) {
	            var _this = this;
	            this._index = i;
	            this._marker.set('label', (i === -1) ? '*' : (i + 1).toString());
	            this._marker.addListener('click', (function (i) {
	                return function (e) {
	                    var _this = this;
	                    this.ngZone.run(function () { return _this.onClick.emit(i); });
	                }.bind(_this);
	            })(i));
	        },
	        enumerable: true,
	    ...
	    MapMarker.prototype.openIW = function () {
	        this._iWOpen = true;
	    };
	    MapMarker.prototype.closeIW = function () {
	        this._iWOpen = false;
	    };
	    MapMarker.prototype.getMarker = function () {
	        return this._marker;
	    };
	    ...
	    ], MapMarker.prototype, "mapContainer", null);
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object), 
	        __metadata('design:paramtypes', [Object])
	    ], MapMarker.prototype, "location", null);
	    __decorate([
	        core_1.Input(), 
	    ...
	    ], MapMarker.prototype, "index", null);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], MapMarker.prototype, "onClick", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapInfowindow = (function () {
	    function MapInfowindow(ngZone) {
	        this.ngZone = ngZone;
	        this.onClose = new core_1.EventEmitter();
	    }
	    Object.defineProperty(MapInfowindow.prototype, "title", {
	        set: function (t) {
	            var _this = this;
	            if (this.infoWindow) {
	            ...
	            iW.addListener('closeclick', (function () {
	                return function (e) {
	                    var _this = this;
	                    this.ngZone.run(function () { return _this.onClose.emit(); });
	                }.bind(_this);
	            })());
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], MapInfowindow.prototype, "mapContainer", void 0);
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], MapInfowindow.prototype, "marker", void 0);
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object), 
	        __metadata('design:paramtypes', [Object])
	    ], MapInfowindow.prototype, "title", null);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], MapInfowindow.prototype, "onClose", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = [
	    ...
	    {
	        path: 'maps2',
	        component: map2_component_1.Map2Component
	    },
	    {
	        path: 'maps2/:id',
	        component: map2_component_1.Map2Component
	...
	exports.mapRouting = router_1.RouterModule.forChild(routes);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginComponent = (function () {
	    function LoginComponent(authService, navService, router) {
	        this.authService = authService;
	        this.navService = navService;
	        this.router = router;
	    }
	    ...
	    LoginComponent.prototype.toggleMode = function () {
	        if (this.signupMode)
	            this.signupMode = false;
	        else
	    ...
	    LoginComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [index_1.AuthService, index_1.NavService, router_1.Router])
	    ], LoginComponent);
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n<h2 *ngIf=\"!signupMode\">Login</h2>\n<button *ngIf=\"!signupMode\" (click)=\"toggleMode()\">Sign Up</button>\n\n<h2 *ngIf=\"signupMode\">signupMode</h2>\n<button *ngIf=\"signupMode\" (click)=\"toggleMode()\">Login</button>\n\n  <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n    <input [(ngModel)]=\"user.username\" class=\"mdl-textfield__input\" type=\"text\" id=\"username\">\n    <label for=\"username\">Username</label>\n  </div>\n\n  <div class=\"mdl-textfield mdl-js-textfield\">\n    <input [(ngModel)]=\"user.password\" class=\"mdl-textfield__input\" type=\"password\" id=\"password\">\n    <label for=\"password\">Password</label>\n  </div>\n\n<div *ngIf=\"signupMode\">\n\n  <div class=\"mdl-textfield mdl-js-textfield\">\n    <input [(ngModel)]=\"user.password\" class=\"mdl-textfield__input\" type=\"password\" id=\"confpassword\">\n    <label for=\"confpassword\">Confirm Password</label>\n  </div>\n\n  <div class=\"mdl-textfield mdl-js-textfield\">\n    <input [(ngModel)]=\"user.email\" class=\"mdl-textfield__input\" type=\"text\" id=\"name\">\n    <label for=\"name\">Email</label>\n  </div>\n\n</div>\n\n<button *ngIf=\"!signupMode\" (click)=\"login()\">Login</button>\n<button *ngIf=\"signupMode\" (click)=\"signUp()\">Sign Up</button>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = (function () {
	    function AppComponent(router, navService, authService) {
	        this.router = router;
	        this.navService = navService;
	        this.authService = authService;
	    }
	    ...
	    AppComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [router_1.Router, index_1.NavService, index_1.AuthService])
	    ], AppComponent);
	    return AppComponent;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavComponent = (function () {
	    function NavComponent(router, navService, authService, titleService) {
	        var _this = this;
	        this.router = router;
	        this.navService = navService;
	        this.authService = authService;
	        this.titleService = titleService;
	        this.defaultTitle = 'My First Angular 2 + Express App!';
	        router.events.subscribe(function (event) {
	            if (event.constructor.name === "NavigationStart") {
	                _this.setTitle(_this.defaultTitle);
	                _this.message = navService.getMessages();
	                _this.getLoggedInUser();
	            }
	            if (event.constructor.name === "NavigationCancel") {
	                _this.message = "You are not authorized to access this page!";
	            }
	        });
	        navService.titleChanged$.subscribe(function (title) { return _this.setTitle(title); });
	        navService.messageChanged$.subscribe(function (message) { return _this.message = message; });
	        navService.loggedIn$.subscribe(function (user) { return _this.loggedInUser = user; });
	    }
	    NavComponent.prototype.ngOnInit = function () {
	    };
	    NavComponent.prototype.setTitle = function (title) {
	        this.title = title;
	    ...
	    NavComponent.prototype.getLoggedInUser = function () {
	        var _this = this;
	        this.authService.getLoggedInUser()
	            .subscribe(function (user) {
	    ...
	    NavComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [router_1.Router, index_1.NavService, index_1.AuthService, platform_browser_1.Title])
	    ], NavComponent);
	    return NavComponent;
	}());
...
/***/ function(module, exports) {
	...
	module.exports = "<header class=\"mdl-layout__header\">\n\n\t<div class=\"mdl-layout__header-row\">\n\t\t<!-- Title -->\n\t\t<span class=\"mdl-layout-title\">{{title}}</span>\n\t\t<!-- Add spacer, to align navigation to the right -->\n\t\t<div class=\"mdl-layout-spacer\"></div>\n\t\t<!-- Navigation -->\n\t\t<nav class=\"mdl-navigation\">\n\n\t\t\t<a routerLink=\"/maps2\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">Maps 2</a>\n\n\t\t\t<a routerLink=\"/users\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">Users</a>\n\t\t\t<a routerLink=\"/editprofile\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">Edit</a>\n\n\t\t\t<a *ngIf=\"!loggedInUser\" routerLink=\"/login\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">Login</a>\n\n\t\t\t<a *ngIf=\"loggedInUser\" [routerLink]=\"['/user', loggedInUser._id]\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">{{loggedInUser.username}}</a>\n\t\t\t<a *ngIf=\"loggedInUser\" (click)=\"logout()\" class=\"mdl-navigation__link\" routerLinkActive=\"active\">Logout</a>\n\n\t\t</nav>\n\n\t</div>\n</header>\n\n<div>{{message}}</div>";
